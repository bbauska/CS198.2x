...
to move forward -- to actually get lunch.
...
event to happen before another -- in both the logical and physical
sense.
...
processes -- the vertical lines -- each with their own set of events --
the points on these lines.
...
In both, there are no notions of a total ordering of events -- events
may appear to happen at different times to different observers, in the
case of relativity, or processes, in the case of distributed systems.
...
So the general consensus nowadays is that Raft is a bit more
understandable than Paxos, and easier to implement.
...
So in Proof-of-Activity, the resources consumed are both Proof-of-Work
and Proof-of-Stake resources.
...
So if you're using Intel SGX, you have to trust Intel and their entire
...
resource consumed -- computational power versus economic stake -- the
rest of the mechanism is largely the same. Once a miner or validator is
...
being used in production in private, permissioned environments. It's
also the backbone of the Cosmos Network, which aims to create the
...
Alright, so let's run a little demo to see how the Tendermint consensus
...
more than ⅔ prevotes, that's called a polka -- hence the image of the
...
their voting power -- which in the case of Proof-of-Stake is however
much every validator decided to stake.

Let's say Rustie gets chosen as the proposer. So in the "Propose" phase,
he proposes the next block. That's the yellow block on top of his name.
...
Alright, so now we're on the next phase, which is precommit. Everyone
...
So this time, we have ⅗ precommits for the block, which isn't more than
...
Casper FFG is a Proof-of-Stake overlay on top of Proof-of-Work that --
as its name implies -- is a tool that aims to fix finality in Ethereum.
In Bitcoin, Ethereum, and many other Proof-of-Work blockchains, we rely
on the probabilistic finality of blocks. For example, in Bitcoin, we
assume that blocks are finalized with reasonable probability if that
block has more than six confirmations on top of it. Though it's unlikely
for the block to be forked by a longer chain, the possibility will
always exist. Hence, the longest chain is never truly final in Bitcoin.
FFG attempts to take away that probabilistic finality from Proof-of-Work
systems.
...
saw the majority was going to vote

for A. However, I really want him to vote for B. I can promise Nadir
that I will pay him P+ε if and only if Nadir votes for B but the
majority votes for A. Nadir, under the belief that he is the only one
who got this deal, will vote for B thinking everyone else will vote for
A. However, I meanwhile have been giving every single actor the same
deal, and each person thinks like Nadir to switch their vote to B, not
...
So what chance does Gloria, the mining pool, actually have at
successfully forking? To answer this question, let's suppose she have q
proportion of the total mining power.
...
Thus we have shown that even with 20 percent of the network hashrate, we
can make it prohibitively expensive for someone to participate in the
Bitcoin network.
...
all voting power is tiattacksed to financial resources.
...
<!------------------------------------------------------------------------------------------------>
<!------------------------ 54. nothing at stake: undesirable path (106) -------------------------->
<!------------------------------------------------------------------------------------------------>
<p align="center" width="100%">
...
could be addressed with centralized or distributed databases -- but not
a blockchain.
...
The Ripple network enables them to have a wider reach -- to expand
payout reach and increase payment volumes.
...
![](images/image100.png){width="5.0in" height="2.7982983377077866in"}
...
![](images/image101.png){width="5.0in" height="2.802623578302712in"}
...
![](images/image107.png){width="5.0in" height="2.8675295275590553in"}
...
blockchain within 2
years.![](images/image109.png){width="1.1805555555555555e-2in"
height="1.1805555555555555e-2in"}

![](images/image110.png){width="5.0in" height="2.8190627734033247in"}
...
![](images/image114.png){width="5.0in" height="2.8432961504811898in"}
...
![](images/image116.png){width="5.0in" height="2.8211384514435696in"}
...
![](images/image117.png){width="5.0in" height="2.8525109361329832in"}
...
![](images/image118.png){width="5.0in" height="2.7831714785651793in"}
...
![](images/image119.png){width="5.0in" height="2.7858300524934383in"}
...
![](images/image120.png){width="5.0in" height="2.7903226159230097in"}
...
![](images/image121.png){width="5.0in" height="2.822580927384077in"}
...
![](images/image122.png){width="5.0in" height="2.7922080052493436in"}
...
![](images/image124.png){width="5.0in" height="2.845528215223097in"}
...
![](images/image125.png){width="5.0in" height="2.822580927384077in"}
...
![](images/image126.png){width="5.0in" height="2.8200962379702537in"}
...
![](images/image127.png){width="5.0in" height="2.8074431321084865in"}
...
![](images/image128.png){width="5.0in" height="2.8165583989501313in"}
...
![](images/image129.png){width="5.0in" height="2.8190627734033247in"}
...
![](images/image130.png){width="5.0in" height="2.7974278215223096in"}
...
![](images/image131.png){width="5.0in" height="2.7903226159230097in"}
...
![](images/image132.png){width="5.0in" height="2.7957852143482063in"}
...
![](images/image133.png){width="5.0in" height="2.800300743657043in"}
...
![](images/image134.png){width="5.0in" height="2.826087051618548in"}
...
![](images/image135.png){width="5.0in" height="2.798199912510936in"}
...
![](images/image137.png){width="5.0in" height="2.787683727034121in"}
...
![](images/image138.png){width="5.0in" height="2.7938812335958003in"}
...
![](images/image139.png){width="5.0in" height="2.7993525809273843in"}
...
![](images/image140.png){width="5.0in" height="2.7948304899387577in"}
...
![](images/image141.png){width="5.0in" height="2.7975109361329835in"}
...
![](images/image142.png){width="5.0in" height="2.837399387576553in"}
...
![](images/image143.png){width="5.0in" height="2.8155336832895888in"}
...
![](images/image144.png){width="5.0in" height="2.7873917322834645in"}
...
![There are two main catogories of databases: Centralized Databases and
Distributed Databases. Within Distributed Databases, there is
Distributed ledgers. Within Distributed ledgers, there is
Blockchain](images/image145.png){width="3.0in" height="3.075in"}

**Centralized databases** are run by a single entity (e.g. a company)
that handles all requests and data processing.

![Central Database](images/image146.png){width="2.0in"
height="3.337117235345582in"}
...
![Distributed Database](images/image147.png){width="3.0in"
height="2.8676760717410326in"}
...
![Distributed Ledger](images/image148.png){width="3.0in"
height="2.959055118110236in"}
...
require some level of permission granted -- as opposed to openly
readable and writable public blockchains.
...
![Miroskii](images/image149.png){width="3.0in"
height="4.491990376202975in"}
...
![](images/image151.png){width="5.0in" height="2.839806430446194in"}

Another property we're looking for is the speed with which we can update
our distributed ledger -- and in the case of blockchain, we call this
the block time: the average time it takes for a new block, or update, to
...
![](images/image152.png){width="5.0in" height="2.8099846894138234in"}
...
![](images/image153.png){width="5.0in" height="2.801933508311461in"}
...
So decentralization in the case of the trilemma is the system being able
to run in a scenario where each participant in the network has access to
on average the same amount of resources.
...
![](images/image154.png){width="5.0in" height="2.8420199037620297in"}
...
![](images/image155.png){width="5.0in" height="2.7957852143482063in"}
...
![](images/image156.png){width="5.0in" height="2.8317147856517937in"}

So here's a quick calculation based on the numbers we've collected so
far for Bitcoin.
...
![](images/image157.png){width="5.0in" height="2.806450131233596in"}
...
![](images/image158.png){width="5.0in" height="2.8084416010498687in"}
...
![](images/image159.png){width="5.0in" height="2.844410542432196in"}
...
![](images/image160.png){width="5.0in" height="2.8155347769028873in"}
...
![](images/image161.png){width="5.0in" height="2.8236253280839896in"}
...
So the first idea we have for a naive scaling solution is to increase
the speed of blocks, thereby decreasing the blocktime.
...
![](images/image163.png){width="5.0in" height="2.8064523184601926in"}
...
![](images/image164.png){width="5.0in" height="2.8260859580052493in"}
...
![](images/image165.png){width="5.0in" height="2.7948304899387577in"}
...
![](images/image167.png){width="5.0in" height="2.8145155293088364in"}
...
![](images/image168.png){width="5.0in" height="2.7967497812773403in"}
...
![](images/image169.png){width="5.0in" height="2.7741940069991253in"}
...
![](images/image171.png){width="5.0in" height="2.8352176290463693in"}
...
second -- and that's not even accounting for the other cons of
increasing block size.

![](images/image172.png){width="5.0in" height="2.82503937007874in"}
...
![](images/image174.png){width="5.0in" height="2.7922080052493436in"}
...
![](images/image175.png){width="5.0in" height="2.8225820209973755in"}
...
![](images/image176.png){width="5.0in" height="2.8099846894138234in"}
...
![](images/image177.png){width="5.0in" height="2.801933508311461in"}
...
So this way, we have information about transactions and their segregated
witnesses all contained within the block header, giving us back all the
beautiful properties of tamper evidence.

![](images/image179.png){width="5.0in" height="2.8135050306211724in"}
...
![](images/image180.png){width="5.0in" height="2.8109853455818024in"}
...
![](images/image181.png){width="5.0in" height="2.7813517060367454in"}
...
![](images/image182.png){width="5.0in" height="2.839805336832896in"}
...
![](images/image183.png){width="5.0in" height="2.8421905074365705in"}
...
![](images/image184.png){width="5.0in" height="2.8135050306211724in"}
...
![](images/image185.png){width="5.0in" height="2.8155347769028873in"}
...
![](images/image186.png){width="5.0in" height="2.796474190726159in"}
...
![](images/image187.png){width="5.0in" height="2.7948304899387577in"}
...
![](images/image189.png){width="5.0in" height="2.8074431321084865in"}
...
Alice is a regular customer at Bob's coffee shop -- and then only
consult the blockchain every once in a while to settle an aggregate
amount.
...
![](images/image190.png){width="5.0in" height="2.7948304899387577in"}
...
![](images/image191.png){width="5.0in" height="2.8165583989501313in"}
...
![](images/image192.png){width="5.0in" height="2.849025590551181in"}
...
![](images/image193.png){width="5.0in" height="2.7938812335958003in"}
...
![](images/image194.png){width="5.0in" height="2.8271391076115484in"}
...
![](images/image195.png){width="5.0in" height="2.806451224846894in"}
...
end -- whenever they choose -- to settle their final balances after
...
![](images/image196.png){width="5.0in" height="2.8074431321084865in"}
...
![](images/image198.png){width="5.0in" height="2.8180347769028873in"}
...
![](images/image199.png){width="5.0in" height="2.798199912510936in"}
...
![](images/image200.png){width="5.0in" height="2.8180544619422574in"}
...
![](images/image201.png){width="5.0in" height="2.847417979002625in"}
...
![](images/image203.png){width="5.0in" height="2.7975874890638672in"}
...
![](images/image204.png){width="5.0in" height="2.8207895888013996in"}
...
![](images/image205.png){width="5.0in" height="2.8225120297462816in"}
...
![](images/image206.png){width="5.0in" height="2.7414818460192474in"}
...
Plasma is a child chain attached to the Ethereum main chain -- also
known as the root chain.
...
![](images/image208.png){width="5.0in" height="2.835051399825022in"}
...
![](images/image209.png){width="5.0in" height="2.7880183727034122in"}
...
![](images/image210.png){width="5.0in" height="2.826885389326334in"}
...
![](images/image211.png){width="5.0in" height="2.852820428696413in"}
...
![](images/image212.png){width="5.0in" height="2.8069225721784776in"}
...
![](images/image213.png){width="5.0in" height="2.783653762029746in"}
...
![](images/image214.png){width="5.0in" height="2.847417979002625in"}
...
![](images/image215.png){width="5.0in" height="2.8242311898512686in"}
...
![](images/image217.png){width="5.0in" height="2.8371511373578304in"}
...
![](images/image218.png){width="5.0in" height="2.7775404636920387in"}
...
-- for example on or off chain -- and the corresponding trust
...
whether we want to engineer blockchains for speed first -- optimizing
for a single application -- or rather architect for flexibility -- for a
...
![](images/image219.png){width="5.0in" height="2.8207895888013996in"}
...
![](images/image220.png){width="5.0in" height="2.8622648731408575in"}
...
![](images/image221.png){width="5.0in" height="2.803909667541557in"}
...
when the users want to settle on a final balance -- all summarized by
two transactions on the main blockchain.
...
![](images/image222.png){width="5.0in" height="2.812298775153106in"}
...
![TPS calculation](images/image223.png){width="3.126388888888889in"
...
![Time to broadcast block fixed while block creation time
decreases](images/image224.png){width="5.206944444444445in"
...
![Payment Channel Network. Alice to Bob to Eve to
Charlie](images/image225.png){width="4.0in"
height="1.2360640857392826in"}
...
![Side chains](images/image226.png){width="4.0in"
height="1.994673009623797in"}
...
![Vertical and Horizontal, Layer 1 and Layer 2 scaling
...
![](images/image229.png){width="5.0in" height="2.784054024496938in"}
...
![](images/image230.png){width="5.0in" height="2.8787554680664917in"}
...
![](images/image231.png){width="5.0in" height="2.812668416447944in"}
...
![](images/image232.png){width="5.0in" height="2.819481627296588in"}
...
![](images/image233.png){width="5.0in" height="2.8194805336832895in"}
...
Also, it's worth mentioning that it's immensely hard -- if not
impossible -- to implement a sense of "morality" at a technological
level.
...
![](images/image243.png){width="5.0in" height="2.7793799212598427in"}
...
In that case, it is not a fair exchange: Bob got Alice\'s item, but
Alice got nothing in return, the poor thing.
...
If the \"item\" being exchanged fits certain criteria, then fair
exchange protocols can be improved upon to have other nice properties,
like no longer requiring a trusted third party or being able to detect a
...
privacy focused altcoin called Bytecoin -- which in turn was based off
of CryptoNote anonymous technology.
...
cryptocurrencies they've seen or used in the past -- like Bitcoin -- so
if users like that, then Zcash shouldn't take that away.
...
scramble inputs and outputs -- to obfuscate the origin and destination
of Bitcoins -- and also for scalability reasons as well.
...
This is true in that you just don't simply achieve privacy -- or it's
not that likely that you can just achieve privacy.
...
security, decentralization, and scalability -- if it wasn't clear
before.
...
![The transaction graph shows the crypto transactions in the network.
Satoshi, Mt Gox and silk road are nodes where most edges are connected
to.](images/image253.jpeg){width="5.0in" height="3.906516841644794in"}
...
![Alice dirty input 1 BTC into the centralized mixing service. And the
Mixer sends cleaned funds after random waiting period. So Alice will get
0.9 BTC as the output(0.1 is the \"cleanning
fee\")](images/image254.png){width="6.5in" height="2.22325678040245in"}
...
transactions into larger transactions \-- this is done to scramble
inputs and outputs.
...
This week\'s material is very light, and focuses on reflecting on how
far we have come so far, and also next steps. The program summary module
...
computers \-- the processes themselves \-- and edges are the messages
...
the three and also observed that the CAP theorem isn\'t really a black
or white trade-off, but actually on a spectrum and especially in the
case of blockchains, the trade-off is generally more between C and P,
and A and P.
...
communicate with each other through messengers \-- and the messengers
can get lost and also there may or may not be a traitor among them.
...
where to get lunch, I don\'t have to trust anyone other than my
immediate close friends, and if anyone else tries to join, then we can
use the intersection of our friend groups to make sure that we all agree
on where to get lunch.
...
Namely at the current problems that we\'re facing today as well as
dreams of how we can scale these blockchains in order to power the use
cases that we looked at in the last lecture.
...
enterprise blockchains and how there\'s varying categories of
blockchains based on their access controls, now we look at the bottom
right section of the triangle which is on scalability.
...
-- conduct as many transactions as they want off chain, and then settle
the final balance back onto the blockchain.
...
There\'s also the idea of side chains in which blockchains plug into
each other like hub-and-spoke.
...
scalability trilemma in which we\'re sacrificing some decentralization
or some scalability for the purpose of security.
...
And now we\'ve made it all the way to the end this is the last lecture
...
![](images/image258.png){width="5.0in" height="2.8257327209098864in"}
...
![](images/image259.png){width="5.0in" height="2.834139326334208in"}
...
![](images/image260.png){width="5.0in" height="2.8327930883639545in"}
...
![](images/image261.png){width="5.0in" height="2.8281999125109363in"}
...
![](images/image262.png){width="5.0in" height="2.829268372703412in"}
...
here [Opens in new
window]{.underline}](https://www.youtube.com/playlist?list=PLZvgWu86XaWlQ22vnBbcHzxPFrmlE3en6).
...
material -- especially CS198.2x week 3 -- has empowered you to judge
these parameters by yourself. 
...
![](images/image263.png){width="5.0in" height="2.8084416010498687in"}
...
![](images/image264.png){width="5.0in" height="2.7580653980752405in"}
...
![](images/image265.png){width="5.0in" height="2.809983595800525in"}
...
![](images/image266.png){width="5.0in" height="2.7813506124234473in"}
...
![](images/image267.png){width="5.0in" height="2.809983595800525in"}
...
![](images/image268.png){width="5.0in" height="2.7681627296587927in"}
...
We\'ll also open up a discussion topic below, under \'Student
Resources\', as a central place where you can post useful resources for
other students. If you recently read, watched, experienced, etc.
...
Cryptocurrencies -- the topic of the first course -- we hope you took
out of this course much more than you thought.
